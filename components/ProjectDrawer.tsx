...
const ProjectDrawer: React.FC<ProjectDrawerProps> = ({ isOpen, onClose, item, type, lang }) => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div 
        className={`fixed right-0 top-0 bottom-0 w-full max-w-4xl bg-bg border-l border-white/10 z-[60] shadow-2xl transform transition-transform duration-500 ease-out ${
